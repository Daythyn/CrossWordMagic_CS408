...
public class CrosswordGridView extends View implements AbstractView {
    ...
    public CrosswordGridView(Context context, AttributeSet attrs) {
        ...
        Log.i("MainActivity", "CW GRID VIEW CREATING");
    ...
    public void onDraw(@NonNull Canvas canvas) {
        ...
        //Log.i("MainActivity", "CW GRID VIEW BEGIN MATH");

        //Log.i("MainActivity", "CW GRID VIEW TING!: " + gridWidth + "W " + gridHeight + "H");
        if (gridWidth > 0 && gridHeight > 0) {
            ...
            //Log.i("MainActivity", "CW GRID VIEW END MATH BEGIN DRAW");
            ...
            //Log.i("MainActivity", "CW GRID VIEW END DRAW");
    ...
    public void modelPropertyChange(final PropertyChangeEvent evt) {
        ...
        if (name.equals(CrosswordMagicController.GRID_LETTERS_PROPERTY)) {
            ...
            if (value instanceof Character[][]) {
                ...
                //Log.i("MainActivity", "CW GRID VIEW LETTERS WORKED!: " + letters.length);
        ...
        if (name.equals(CrosswordMagicController.GRID_NUMBERS_PROPERTY)) {
            ...
            if (value instanceof Integer[][]) {
                ...
                //Log.i("MainActivity", "CW GRID VIEW NUMBERS WORKED!: " + numbers.length);
        ...
        if (name.equals(CrosswordMagicController.GRID_DIMENSION_PROPERTY)) {
            ...
            //Log.i("MainActivity", "SCREEEEEEEE (DIMS PROBLEMS) : " + value);

            if (value instanceof Integer[]) {

                Integer[] dimension = (Integer[]) value;

                //Log.i("MainActivity", "DIM PROP CHANGE: " + dimension[0] + " " + dimension[1]);

                this.gridHeight = dimension[0];
                this.gridWidth = dimension[1];

                //Log.i("MainActivity", "CW GRID DIM PROPERTY WORKED!: " + gridWidth + "W" + dimension[0] + " " + gridHeight +"H" + dimension[1]);
        ...
        if (name.equals(CrosswordMagicController.CHECK_GUESS)) {
            WordDirection result = (WordDirection) value;
            if(result == WordDirection.ACROSS || result == WordDirection.DOWN){

                String text = "Congratulations, You Guessed Correctly!";
        ...
        public boolean onTouch(View view, MotionEvent event) {
            ...
            if (eventX >= xBegin && eventX <= xEnd && eventY >= yBegin && eventY <= yEnd) {
                ...
                if (n != 0) {
                    ...
                    Log.i("MainActivity", "LAUNCHING ALERT DIALOG");
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface d, int i) {
                            ...
                            //Do stuff here
                            String[] guess = new String[]{String.valueOf(n),userInput.toUpperCase()};

                            Log.i("MainActivity", "CHECKING GUESS :  Box " + guess[0] + " " + guess[1]);

                            controller.getCheckGuess(guess);
